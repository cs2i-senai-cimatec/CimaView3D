...
*IMPORTANT*: Make sure you have a copy of the file named =CimaView3D.py= in the project. If you have it at the same level of the file that you are working on, you can import it with the following line:
